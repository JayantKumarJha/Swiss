...
if uploaded_file:
    ...
    # ✅ Speed override panel for ampoules
    ...
    for size in unique_sizes:
        if isinstance(size, (int, float)):
            ...
            override_speed[size] = st.sidebar.number_input(
                f"Speed for {int(size)}ml", min_value=1, max_value=1000, value=default
            )
    ...
    if too_big_batches:
        st.warning("⚠️ Some batches were too large to fit and skipped:")
