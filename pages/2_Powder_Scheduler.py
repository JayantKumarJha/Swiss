...
if uploaded_file:
    ...
    # ✅ Speed override panel for vial pack sizes
    st.sidebar.subheader("✏️ Speed Override (e.g., 1m, 2t, etc.)")
    default_speed_vials = {
    ...
    for size in unique_sizes:
        ...
        override_speed[size] = st.sidebar.number_input(f"{size}", 1, 1000, value=default)
